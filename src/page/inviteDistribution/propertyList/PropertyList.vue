...
// import {iosDetail, AndroidDetail} from '../../../common/httpClient.js'
  ...
  methods: {
    click (item) {
      if (this.$route.name === 'channel') {
        ...
        this.$router.push({
          path: '/invitePropertyDetail/' + item.id,
          query: {
      ...
      //   // this.goApp(item, this.goTencent())
      //   // util.openApp('fjj://housing/detail?buildingGroupId=' + item.id + '&accountId=' + this.$route.query.accountId, 'https://a.app.qq.com/o/simple.jsp?pkgname=com.housing.network.broker')
      //   window.location.href = 'fjj://housing/detail?buildingGroupId=' + item.id + '&accountId=' + this.$route.query.accountId
      ...
      //   // this.goApp(item, this.goTencent())
      //   window.location.href = 'jrfwinviteschemes://houseDetail?id=' + item.id + '&accountId=' + this.$route.query.accountId
      //   let loadDateTime = Date.now()
      //   this.timer = setTimeout(() => {
      //     let timeOutDateTime = Date.now()
