  ...
  <div class="th_property_service_detail">
    <th-layout>
      ...
      <div class="th_property_service_detail-cont" ref="cont">
        <div :class="isIos? (isJrfwFjj? 'isJrfwFjj titleTab' : (isJrfwFgj? 'isJrfwFgj titleTab' : 'titleTab')) : 'titleTab none'">
          <span class="soy"></span>
          <mt-navbar v-model="active">
            <mt-tab-item id="selfCar" v-show="selfCarFalg">自驾补贴</mt-tab-item>
            <mt-tab-item id="specialCar" v-show="specialCarFalg">免费专车</mt-tab-item>
      ...
      <div slot="footer" class="th_property_service_detail-footer" @click="submit">
        立即报备
      </div>
    </th-layout>
    <th-date-picker
...
export default {
  data () {
    return {
      ...
      regularCarCon: '',
      selfCarFalg: false,
      specialCarFalg: false,
      regularCarFalg: false,
      popupVisible: false,
