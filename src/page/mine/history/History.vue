<template>
  <div class="th_history">
    <tx-layout :hiddenFooter="true">
      <div class="th_history-cont" ref="cont"  v-infinite-scroll="loadMore" infinite-scroll-distance="20">
...
<script>
import {setBuildingHistory} from '../../../common/httpClient.js'
...
export default {
  ...
  methods: {
    ...
    getData () {
      ...
      setBuildingHistory(data).then((res) => {
        this.loading = false
        if (res && res.code === 1) {
